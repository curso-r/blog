...
image_join(im1, im2) %>% 
  ...
  image_scale("400x297") %>% 
  image_write('../../static/images/posts/banner/music01.jpg')
```
...
knitr::include_graphics('/images/posts/conteudo/music01/music-download.png')
```
...
```{r, echo=FALSE, out.width='40%', fig.align='center'}
knitr::include_graphics('/images/posts/conteudo/music01/music-generate.png')
```
...
```{r, echo=FALSE, out.width='40%', fig.align='center'}
knitr::include_graphics('/images/posts/conteudo/music01/music-transform.png')
```
...
![](/images/posts/conteudo/music01/note-1.png)
...
![](/images/posts/conteudo/music01/bach-1.png)
