...
tags: ["música"]
categories: ["análises"]
image: "images/posts/banner/music01.webp"
author: ["Julio"]
...
image_join(im1, im2) %>%
  ...
  image_scale("400x297") %>%
  image_write('../../static/images/posts/banner/music01.webp')
```
...
knitr::include_graphics('/images/posts/conteudo/music01/music-download.webp')
```
...
```{r, echo=FALSE, out.width='40%', fig.align='center'}
knitr::include_graphics('/images/posts/conteudo/music01/music-generate.webp')
```
...
```{r, echo=FALSE, out.width='40%', fig.align='center'}
knitr::include_graphics('/images/posts/conteudo/music01/music-transform.webp')
```
...
![](/images/posts/conteudo/music01/note-1.webp)
...
![](/images/posts/conteudo/music01/bach-1.webp)
