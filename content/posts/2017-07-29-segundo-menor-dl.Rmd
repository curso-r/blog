...
image: "images/posts/banner/what_if_i_told_you.jpeg"
author: ["Athos"]
...
knitr::include_graphics("/images/posts/conteudo/segundo-menor-dl/y1.png", error = FALSE)
```

**Resposta `y_2`**

```{r, fig.height=3, echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/segundo-menor-dl/y2.png", error = FALSE)
```
...
knitr::include_graphics("/images/posts/conteudo/segundo-menor-dl/dl_inf.png", error = FALSE)
```
