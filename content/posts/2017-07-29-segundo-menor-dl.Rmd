...
knitr::include_graphics("/images/posts/conteudo/segundo-menor-dl/y1.png")
```

**Resposta `y_2`**

```{r, fig.height=3, echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/segundo-menor-dl/y2.png")
```
...
knitr::include_graphics("/images/posts/conteudo/segundo-menor-dl/dl_inf.png")
```
