...
```{r echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-08-googlesheets4/url.png")
```
...
knitr::include_graphics("/images/posts/conteudo/2022-03-08-googlesheets4/auth1.png")
```

Precisamos então clicar no email desejado, selecionar todas as opções de acesso e clicar em "Continuar":

```{r echo=FALSE, out.width="50%", fig.align='center'}
knitr::include_graphics("/images/posts/conteudo/2022-03-08-googlesheets4/auth2.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-08-googlesheets4/forms1.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-08-googlesheets4/forms2.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-08-googlesheets4/forms3.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-08-googlesheets4/forms4.png")
```
Cada coluna terá informações de uma pergunta do formulário. Inicialmente, a base terá 0 linhas, pois quando criamos o formulário ele tem 0 respostas. Porém, após alguém responder o formulário, a Google Sheet é automaticamente atualizada e apresentará a resposta. Podemos imp
