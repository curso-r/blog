...
```{r echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-08-googlesheets4/url.webp")
```
...
knitr::include_graphics("/images/posts/conteudo/2022-03-08-googlesheets4/auth1.webp")
```

Precisamos então clicar no email desejado, selecionar todas as opções de acesso e clicar em "Continuar":

```{r echo=FALSE, out.width="50%", fig.align='center'}
knitr::include_graphics("/images/posts/conteudo/2022-03-08-googlesheets4/auth2.webp")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-08-googlesheets4/forms1.webp")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-08-googlesheets4/forms2.webp")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-08-googlesheets4/forms3.webp")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-08-googlesheets4/forms4.webp")
```
