...
image: "images/posts/banner/2022-03-22-esquisse.jpg"
author: ["Tereza"]
summary: "Essa ferramenta facilita muito a criação de gráficos ggplot2, não havendo a necessidade de digitar as linhas de código, tudo é feito de maneira point and click!"
draft: false
---
...
knitr::include_graphics("/images/posts/conteudo/2022-03-22-esquisse/esquisse001.png")
```
...
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-22-esquisse/esquisse002.png")
```

Na aba “Labels & Title” você pode editar os títulos e legendas:

```{r, fig.align='center', echo = FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-22-esquisse/esquisse003.png")
```

Na aba “Appearance” você pode mudar as cores e aparência do gráfico, de maneira geral:

```{r, fig.align='center', echo = FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-22-esquisse/esquisse004.png")
```

Além disso, na aba “Data” é possível filtrar algumas variáveis da base de dados, e isso é feito com a função filter do {dplyr}:

```{r, fig.align='center', echo = FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-22-esquisse/esquisse005.png")
```

E enfim, na aba “Code” você pode recuperar o código que gera o gráfico, para colocá-lo em sua análise de dados, por exemplo!

```{r, fig.align='center', echo = FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-22-esquisse/esquisse006.png")
```
