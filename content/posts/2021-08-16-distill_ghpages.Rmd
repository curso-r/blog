...
image: "images/posts/banner/distill_ghpages.png"
author: ["Athos"]
...
knitr::include_graphics("2021-08-16-distill_ghpages/githubpages.gif")
```
...
```{r, echo = FALSE, layout="l-body-outset", fig.cap="ghpages"}
knitr::include_graphics("2021-08-16-distill_ghpages/githubpageslink.png")
```
