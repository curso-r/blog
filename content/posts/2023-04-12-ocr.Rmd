...
date: "2023-04-12T13:07:31+02:00"
...
[Vamos usar esse exemplo de PDF digital](/posts/2023-04-12-ocr/pdf_digital.pdf)
...
[Vamos usar esse exemplo de PDF digitalizado](/posts/2023-04-12-ocr/pdf_digitalizado.pdf)
...
Infelizmente, o `pdftools` não transforma em HTML nem XML. Para soltar um HTML, vamos montar uma função que chama `pdftohtml` do `poppler` por command line.
...
Vamos usar [esse pdf de exemplo](/posts/2023-04-12-ocr/pdf_compras.pdf).
...
tab_tidy <- tab |>
  ...
  mutate(across(
    everything(), 
    \(x) str_trim(str_replace_all(x, '[[:space:]]+', ' '))
  ))
```
...
Vamos usar [esse pdf de exemplo](/posts/2023-04-12-ocr/pdf_digitalizado.pdf).
