...
image: "images/posts/banner/clipr.webp"
author: ["Tereza"]
...
knitr::include_graphics("/images/posts/conteudo/2021-12-27-clipr/clipr1.webp")
```
...
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics("/images/posts/conteudo/2021-12-27-clipr/clipr2.webp")
```
...
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics("/images/posts/conteudo/2021-12-27-clipr/clipr3.webp")
```
...
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics("/images/posts/conteudo/2021-12-27-clipr/clipr4.webp")
```
...
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics("/images/posts/conteudo/2021-12-27-clipr/clipr5.webp")
```
