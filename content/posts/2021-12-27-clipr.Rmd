---
title: "Importando e exportando objetos do R através da área de transferência"
date: "2021-12-27"
tags: ["tutoriais"]
categories: ["tutoriais"]
image: "images/posts/banner/clipr.jpg"
author: ["Tereza"]
summary: "Aprenda a importar/exportar objetos do R através do pacote clipr"
draft: false
---
...
knitr::include_graphics("/images/posts/conteudo/2021-12-27-clipr/clipr1.png")
```
...
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics("/images/posts/conteudo/2021-12-27-clipr/clipr2.png")
```
...
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics("/images/posts/conteudo/2021-12-27-clipr/clipr3.png")
```
...
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics("/images/posts/conteudo/2021-12-27-clipr/clipr4.png")
```
...
```{r, fig.align='center', echo = FALSE}
knitr::include_graphics("/images/posts/conteudo/2021-12-27-clipr/clipr5.png")
```
