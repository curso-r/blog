...
image: "images/posts/banner/zen-do-r-4.jpeg"
author: ["Caio"]
...
knitr::include_graphics("/images/posts/conteudo/zen-do-r/03_pat.png")
```
...
```{r, echo=FALSE, fig.align='center', dpi=50}
knitr::include_graphics("/images/posts/conteudo/zen-do-r/03_git.png")
```
