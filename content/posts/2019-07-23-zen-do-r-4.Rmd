...
image: "images/posts/banner/zen-do-r-4.webp"
author: ["Caio"]
...
distribuído conhecido como Git.
...
knitr::include_graphics("/images/posts/conteudo/zen-do-r/03_pat.webp")
```
...
```{r, echo=FALSE, fig.align='center', dpi=50}
knitr::include_graphics("/images/posts/conteudo/zen-do-r/03_git.webp")
```
