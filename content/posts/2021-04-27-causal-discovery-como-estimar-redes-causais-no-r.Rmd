...
Similar ao o que fizemos na live, aqui vamos procurar um grafo de relacionamentos entre as variáveis da base `Auto`, disponível no pacote `ISLR`. Vamos excluir algumas variáveis dessa base e aplicar algumas transformações:
