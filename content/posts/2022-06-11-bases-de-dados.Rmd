...
image: "images/posts/banner/welcome_to_rstats.jpeg"
...
É possível consultar a lista de bases de dados neste link: [tidytuesday datasets](https://github.com/rfordatascience/tidytuesday#datasets). Ao entrar na página de uma base de dados, o código para carregar a mesma é mostrado. Por exemplo: para usar os dados de [Jogos de tabuleiro](https://github.com/rfordatascience/tidytuesday/blob/master/data/2022/2022-01-25/readme.md), podemos usar o seguinte código:
...
Por lá, também estão disponíveis diversas bases de dados, na [página de datasets](https://www.kaggle.com/datasets). Um ponto importante para citar é que qualquer pessoa consegue fazer upload de uma base lá no Kaggle, então pesquise com calma e veja as bases mais bem avaliadas no tema que você quer explorar! Depois que escolher, é possível baixar a base de dados e importar para o R.
