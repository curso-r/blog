...
knitr::include_graphics("/images/posts/conteudo/2022-06-28-rspotify/rspotify001.png")
```
...
```{r echo=FALSE, fig.align='center', warning=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-06-28-rspotify/rspotify002.png")
```

4 - Dê um nome e uma descrição para o seu app, assinale a caixinha de Termos de Uso, e então, clique em **Create**

```{r echo=FALSE, fig.align='center', warning=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-06-28-rspotify/rspotify003.png")
```

5 - Depois de criar o app, você será redirecionado para essa tela. Clique em **edit settings**

```{r echo=FALSE, fig.align='center', warning=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-06-28-rspotify/rspotify004.png")
```

6 - Preencha o campo **Redirect URIs** com "http://localhost:1410/" (sem as aspas), e clique em **Add**

```{r echo=FALSE, fig.align='center', warning=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-06-28-rspotify/rspotify005.png")
```

A tela deve ficar assim:

```{r echo=FALSE, fig.align='center', warning=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-06-28-rspotify/rspotify006.png")
```

7 - Agora, role até o final da página e clique em **Save**

```{r echo=FALSE, fig.align='center', warning=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-06-28-rspotify/rspotify007.png")
```

8 - Clique no botão **Show client secret**

```{r echo=FALSE, fig.align='center', warning=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-06-28-rspotify/rspotify008.png")
```
