---
title: "Criando uma pirâmide etária com dados do Censo 2022, usando o R e o pacote ggplot2"
date: "2024-05-27"
tags: ["programação", "ggplot2"]
categories: ["tutoriais"]
image: "images/posts/banner/piramide-etaria.png"
author: ["Beatriz Milz"]
...
![IBGE: Pirâmide etária do Brasil](/images/posts/conteudo/2024-05-27-piramide-etaria/piramide_etaria_ibge.png)
...
![Nexo: Pirâmide etária do Brasil](/images/posts/conteudo/2024-05-27-piramide-etaria/piramide-etaria-nexo.png)
...
![Panorama Censo 2022 - Pesquisa por município ou UF, e botão de download](/images/posts/conteudo/2024-05-27-piramide-etaria/panorama.png)
...
```         
dados/Censo 2022 - Características dos domicílios - Diadema (SP).csv
dados/Censo 2022 - Características dos domicílios - Osasco (SP).csv
dados/Censo 2022 - Crescimento Populacional - Diadema (SP).csv
dados/Censo 2022 - Crescimento Populacional - Osasco (SP).csv
dados/Censo 2022 - Pirâmide etária - Diadema (SP).csv
dados/Censo 2022 - Pirâmide etária - Osasco (SP).csv
dados/Censo 2022 - População por cor ou raça - Diadema (SP).csv
dados/Censo 2022 - População por cor ou raça - Osasco (SP).csv
dados/Censo 2022 - População por sexo - Diadema (SP).csv
dados/Censo 2022 - População por sexo - Osasco (SP).csv
dados/Censo 2022 - Território - Diadema (SP).csv
dados/Censo 2022 - Território - Osasco (SP).csv
```
...
$ `Código do Município`          <dbl> 3513801, 3513801, 3513801, 3513801, 351…
```

## Arrumando os dados {#arrumando-os-dados}
...
$ codigo_do_municipio         <dbl> 3513801, 3513801, 3513801, 3513801, 351380…
```
...
## Estrutura de um ggplot {#estrutura-de-um-ggplot}
...
1.  Esse é o formato que queremos! Agora temos uma coluna para o sexo, e outra coluna para a população. Veja que agora temos DUAS linhas para cada combinação de `grupo_de_idade` e `municipio`. Por isso, esse tipo de transformação deixa a base “mais longa”.
...
$ populacao           <dbl> 30, 6, 138, 52, 477, 193, 1136, 536, 2080, 1205, 3…
```

## Primeira tentativa de criar um gráfico {#primeira-tentativa-de-criar-um-gráfico}
...
dados_piramide_longo |>
  ...
  geom_col()
```
![](/images/posts/conteudo/2024-05-27-piramide-etaria/grafico-1-1.png)
...
![](/images/posts/conteudo/2024-05-27-piramide-etaria/grafico-2-1.png)
...
![](/images/posts/conteudo/2024-05-27-piramide-etaria/grafico-3-1.png)
...
![](/images/posts/conteudo/2024-05-27-piramide-etaria/grafico-4-1.png)
...
![](/images/posts/conteudo/2024-05-27-piramide-etaria/grafico-5-1.png)
...
![](/images/posts/conteudo/2024-05-27-piramide-etaria/grafico-6-1.png)
