...
# verificar se as tags estão clicáveis: "desafio curso-r", "desafio manipulação", "Tereza"
```
...
Poste a sua resolução em nosso [Discourse](https://discourse.curso-r.com/) :)


```{r eval=FALSE, include=FALSE}
# VERIFICAR:

# vai ser criado um único tópico pra cada desafio? ou vai ser um tópico por resolução?

# TO DO:

# escrever mais alguma coisa, se vai ter premio, dar dicas, etc
```
