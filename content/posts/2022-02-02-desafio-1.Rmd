...
date: "2021-02-02"
tags: ["desafio curso-r", "desafio manipulação"]
categories: ["desafio curso-r"]
image: "images/posts/banner/desafio-1.jpg"
author: ["Tereza"]
summary: "Esse é o primeiro desafio de programação proposto pela curso-R! Resolva-o e poste a sua solução no nosso discouse!"
draft: true
---
...
**Objetivo**: Escreva um código que transforme a base do IMDB em uma base nomeada *IMDB_atores*, que deve ser formada pelas seguintes colunas:
...
(especificar onde deve ser postada a resolução dos desafios)
