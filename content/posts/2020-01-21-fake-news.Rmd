---
title: "Camadas de Fake News"
date: "2020-01-21"
tags: ["fake news"]
categories: ["análises"]
image: "images/posts/banner/fake-news.webp"
author: ["Caio"]
summary: "Uma fake news dura de roer. Como um gráfico pode estar tecnicamente certo e ao mesmo tempo não ser correto."
---

## Eu Tenho um Problema

Esse problema se chama *fake news*. Não importa a fonte, a inclinação
...
ludibriar o leitor eu perco o controle.

Normalmente eu ignoro a mensagem/foto/montagem e sigo com o meu dia, mas
...
com o único objetivo de desmentir a *fake news*. Geralmente em menos de
meia hora já tenho uma resposta pronta com dados confiáveis, uma imagem
sem Photoshop ou simplesmente um link para um site de *fact-checking*.
Mas ontem aconteceu algo inédito: a mentira lutou contra mim.

## A “Notícia”

A “notícia” falsa em questão é na verdade uma imagem. Uma imagem
alterada, por sinal.

<img src="/images/posts/conteudo/2020-01-21-fake-news_files/photo_2020-01-21_12-37-31.webp" style="display: block; margin: auto;" />

Vamos por partes. Meu espanhol não é dos melhores, mas acho que qualquer
...
De acordo com o que me parece ser a [imagem
original](https://twitter.com/rcas1/status/1068171172766994432), nesta
versão da notícia ganhamos de brinde também uma pequena intervenção
“artística” na forma de duas figuras da política Argentina: [Juan
Bautista Alberdi](https://pt.wikipedia.org/wiki/Juan_Bautista_Alberdi)
(um dos principais responsáveis pela primeira Constituição argentina) e
[Juan Domingo
Perón](https://pt.wikipedia.org/wiki/Juan_Domingo_Per%C3%B3n) (três
vezes presidente da Argentina). O texto que acompanha a foto de Perón
nos “informa” sobre a [Constituição
de 1949](https://pt.wikipedia.org/wiki/Constituição_Argentina#A_Constituição_de_53_e_a_história_política_argentina),
quando o governo peronista reforma a Carta Magna e aparentemente dá
início à “justiça social”.

O que esta imagem parece estar sugerindo é que Perón é o grande culpado
...
per capita com desenvolvimento econômico ou qualidade de vida.

Mas, como dito anteriormente, esta imagem não é uma *fake news*
qualquer: para desmentí-la será necessário explorar algumas camadas da
narrativa sendo traçada.

## Os Dados Não Mentem…

Diferentemente da maior parte das *fake news*, esta possui uma fonte. Os
dados foram retirados do [Maddison
Project](https://www.rug.nl/ggdc/historicaldevelopment/maddison/releases/maddison-project-database-2018),
...
longínquo (mais sobre isso em breve).

Sendo assim, acessei o site do projeto e coletei os dados. Eles não
...
<img src="/images/posts/conteudo/2020-01-21-fake-news_files/figure-gfm/unnamed-chunk-2-1.webp" style="display: block; margin: auto;" />

Quando vi o gráfico, fiquei boquiaberto. Uma imagem em baixa resolução,
...
desqualificar um argumento.

## …Mas Podem Enganar

Mesmo estando **tecnicamente** certo, um gráfico não necessariamente
...
Argentina e não sobre ela em relação às de todos os outros países.

<img src="/images/posts/conteudo/2020-01-21-fake-news_files/figure-gfm/unnamed-chunk-3-1.webp" style="display: block; margin: auto;" />

O que me chamou a atenção no gráfico acima foi que os PIBs per capita da
...
assim, fui saber mais sobre o conceito de Produto Interno Bruto.

Em primeiro lugar, descobri que a [definição
moderna](https://en.wikipedia.org/wiki/Gross_domestic_product) de PIB só
existe desde 1934 e que ele só começou a ser utilizado para medir a
economia dos países a partir de 1944.

E agora entra em jogo o que de fato é o projeto Maddison. Já comentei
...
Voltando para a base, percebi que isso explicava a quantidade de países
...
apenas os 28 países iniciais:

<img src="/images/posts/conteudo/2020-01-21-fake-news_files/figure-gfm/unnamed-chunk-4-1.webp" style="display: block; margin: auto;" />

Fiz questão de manter a escala deste gráfico igual à do anterior porque
...
50 posições no mesmo período.

Para entender ainda melhor o que a imagem original está escondendo,
basta exibir no gráfico os dados de **todos** os países contemplados
pela base.

<img src="/images/posts/conteudo/2020-01-21-fake-news_files/figure-gfm/unnamed-chunk-5-1.webp" style="display: block; margin: auto;" />

Note como a quantidade de países presentes na tabela cresce
...
mesmo gráfico, é possível utilizar a função `dplyr::percent_rank()` que,
ao invés de atribuir números naturais como ranking, retorna o ranking
dividido pelo total de elementos na comparação.

<img src="/images/posts/conteudo/2020-01-21-fake-news_files/figure-gfm/unnamed-chunk-6-1.webp" style="display: block; margin: auto;" />

Aqui fica claro que, mesmo depois de piorar muito no ranking do PIB per
...
Conclusão muito diferente da sugerida pela imagem original.

## …E História Também

A última camada dessa *fake news* é um pouco mais sutil e não pode ser
...
Sem querer entrar na discussão “peronistas vs. antiperonistas”, mas
...
A imagem é claramente montada para manchar o legado de Perón e, para
...
soar meu alarme de notícia falsa.

O que aprendi sobre a história argentina, entretanto, parece colocar em
...
y 1898, y exclusión de la de 1949”.

Agora acho importante fazer uma visualização final, destacando a
vigência da Constituição que deu início à “justiça social”:

<img src="/images/posts/conteudo/2020-01-21-fake-news_files/figure-gfm/unnamed-chunk-7-1.webp" style="display: block; margin: auto;" />

Sugiro que os autores da imagem original façam a mesma montagem com o
gráfico acima.
