...
image: "images/posts/banner/marks.jpeg"
...
```{r echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/rfacebook/Erro.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/rfacebook/app.png")
```
