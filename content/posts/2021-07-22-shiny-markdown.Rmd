...
Veja que só precisamos usar a tag `img` para deixar a imagem redonda. Caso contrário, o código seria totalmente Markdown. A mesma mini bio já é bem mais chato de construir e manter na UI de um shiny app.
