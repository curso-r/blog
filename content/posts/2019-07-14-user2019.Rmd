...
tags: ["comunidade", "useR"]
categories: ["divulgação"]
image: "images/posts/banner/user2019.jpg"
author: ["Julio"]
...
knitr::include_graphics("/images/posts/conteudo/user2019/tidydev.jpg")
```
...
knitr::include_graphics("/images/posts/conteudo/user2019/julia-1.png")
```

```{r, fig.cap="Que vontade de abraçar esses slides."}
knitr::include_graphics("/images/posts/conteudo/user2019/julia-2.png")
```
...
knitr::include_graphics("/images/posts/conteudo/user2019/bea.jpg")
```
...
knitr::include_graphics("/images/posts/conteudo/user2019/vroom.jpg")
```
...
knitr::include_graphics("/images/posts/conteudo/user2019/auth0.jpg")
```
...
knitr::include_graphics("/images/posts/conteudo/user2019/hadley-copo.jpg")
```
...
knitr::include_graphics("/images/posts/conteudo/user2019/hadley-mao.jpg")
```

```{r, fig.cap="Lexie, filha do Romain François (o do cabelo colorido), brincando com o Daniel Falbel. Coisa mais fofa!", out.width="40%"}
knitr::include_graphics("/images/posts/conteudo/user2019/lexie.jpg")
```

```{r, fig.cap="Playmobil com um pipe no escudo, da ThinkR", out.width="80%"}
knitr::include_graphics("/images/posts/conteudo/user2019/playmobil.jpg")
```

```{r, fig.cap="Turma dos BR (+Laurie) na useR!", out.width="100%"}
knitr::include_graphics("/images/posts/conteudo/user2019/brasileiros.jpg")
```
