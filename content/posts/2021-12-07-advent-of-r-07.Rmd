...
carangueijos deveria se alinhar, com a restrição de que deveríamos encontrar a
posição que exigisse menos combustível.

Cada carangueijo estava equipado de um mini-submarino que gastava 1 unidade de
...
saída era o combustível gasto para levar todos os carangueijos até a posição
mais econômica.
...
de combustível para cada posição. Se um carangueijo estiver na posição `a` e
