...
Ao carregar o pacote pela primeira vez, a seguinte mensagem aparecerá, dizendo que é possível armazenar as credenciais em uma pasta chamada `AzureR` e pergunta se permitimos que o pacote crie esse diretório. Eu aceitei respondendo com `Yes`:
...
```{r echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/2022-03-18-onedrive/auth-onedrive.png")
```
...
Espero que este post seja útil para quem usa o One Drive também. Espero que o pacote seja aprimorado para conseguir importar os dados sem que seja necessário baixá-los.
