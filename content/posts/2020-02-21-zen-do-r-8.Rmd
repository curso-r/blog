...
image: "images/posts/banner/zen-do-r-8.jpeg"
author: ["Caio"]
...
knitr::include_graphics("/images/posts/conteudo/zen-do-r/03_ver.png")
```
...
```{r, echo=FALSE, fig.align='center', dpi=50}
knitr::include_graphics("/images/posts/conteudo/zen-do-r/03_tag.png")
```
