...
plot(image_read('../../staticimages/posts/conteudo/a-kind-of-magick/freddie-mercury.jpeg'))
```
...
```{r, echo = FALSE, fig.width = 8, fig.height = 7, eval = TRUE}
freddie <- image_read('../../staticimages/posts/conteudo/a-kind-of-magick/freddie-mercury.jpeg')
image_info(freddie)
```
...
image_read(path = "../../staticimages/posts/conteudo/a-kind-of-magick/freddie_1.jpg") %>% plot
```
...
image_read(path = "../../staticimages/posts/conteudo/a-kind-of-magick/freddie_2.jpg") %>% plot
```
...
```{r, echo = FALSE, fig.width = 8, fig.height = 7}
image_read(path = "../../staticimages/posts/conteudo/a-kind-of-magick/freddie_3.jpg") %>% plot
```
...
```{r, echo = FALSE, fig.width = 8, fig.height = 7}
image_read(path = "../../staticimages/posts/conteudo/a-kind-of-magick/freddie_4.jpg") %>% plot
```
...
```{r, echo = FALSE, fig.width = 4, fig.height = 3}
image_read(path = "../../staticimages/posts/conteudo/a-kind-of-magick/freddie_5.jpg") %>% plot
```
...
image_read(path = "../../staticimages/posts/conteudo/a-kind-of-magick/freddie_6.jpg")  %>% plot
```
...
```{r, echo = FALSE, fig.width = 7, fig.height = 5}
image_read(path = "../../staticimages/posts/conteudo/a-kind-of-magick/freddie_7.jpg") %>% plot
```
...
```{r, echo = FALSE, fig.width = 7, fig.height = 5}
image_read(path = "../../staticimages/posts/conteudo/a-kind-of-magick/freddie_9.jpg") %>% plot
```
...
library(grid)
qplot(speed, dist, data = cars, geom = c("point", "smooth"))
image_read(path = "../../staticimages/posts/conteudo/a-kind-of-magick/freddie_1.jpg") %>%
