...
image: "images/posts/banner/out_0262.png"
author: ["Julio"]
...
knitr::include_graphics("/images/posts/conteudo/2018-02-21-2cents/out_0045.png")
```
...
#   image_read() %>% 
#   image_append() %>% 
#   image_write("../../static/images/posts/conteudo/2018-02-21-2cents/frames.png")
knitr::include_graphics("/images/posts/conteudo/2018-02-21-2cents/frames.png")
```
...
knitr::include_graphics("/images/posts/conteudo/2018-02-21-2cents/out_0277.png")
```
...
# "../../static/images/posts/conteudo/2018-02-21-2cents/out_0277.png" %>%
#   cortar_canto() %>% 
#   limpar_imagem() %>% 
#   magick::image_read() %>% 
#   image_write("../../static/images/posts/conteudo/2018-02-21-2cents/out_raw.png")
# 
knitr::include_graphics("/images/posts/conteudo/2018-02-21-2cents/out_raw.png")
```
...
```{r, echo=FALSE, eval=TRUE, fig.align='center'}
knitr::include_graphics("/images/posts/conteudo/2018-02-21-2cents/out_0301.png")
```
...
```{r, echo=FALSE, eval=TRUE, fig.align='center'}
knitr::include_graphics("/images/posts/conteudo/2018-02-21-2cents/out_0266.png")
```
