...
image: "images/posts/banner/fluxo_github_rstudio2.webp"
author: ["Athos"]
...
knitr::include_graphics("/images/posts/conteudo/rstudio-e-github/fluxo_github_rstudio.webp", error = FALSE)
```
...
knitr::include_graphics("/images/posts/conteudo/rstudio-e-github/github_dps_do_push.webp", error = FALSE)
```
