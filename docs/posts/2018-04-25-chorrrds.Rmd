...
tags: ["música"]
categories: ["análises"]
image: "images/posts/banner/chorrrds.webp"
...
knitr::include_graphics("/images/posts/conteudo/2018-04-25-chorrrds/media-acordes-musicas.webp")
```
...
```{r, echo=FALSE, eval=TRUE, fig.align='center'}
knitr::include_graphics("/images/posts/conteudo/2018-04-25-chorrrds/stats-artistas.webp")
```
