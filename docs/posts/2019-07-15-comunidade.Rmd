...
date: "2019-08-19"
tags: ["discussões", "comunidade"]
categories: ["discussões"]
image: "images/posts/banner/comunidade.png"
author: ["Julio"]
...
type: featured
featuredImage: "images/posts/banner/feat-comunidade.jpg"
---
...
knitr::include_graphics("/images/posts/conteudo/comunidade/rubber-sheet.png", error = FALSE)
```
...
```{r}
knitr::include_graphics("/images/posts/conteudo/comunidade/gentileza.png", error = FALSE)
```
...
knitr::include_graphics("/images/posts/conteudo/comunidade/bad_opinions.png", error = FALSE)
```
...
knitr::include_graphics("/images/posts/conteudo/comunidade/rladies-growth.jpeg", error = FALSE)
```
