...
knitr::opts_chunk$set(collapse = TRUE, fig.align = "center", cache = TRUE, eval = FALSE)
...
knitr::include_graphics("/images/posts/conteudo/captcha-conv/vivalaconv.jpg")
```
...
```{r}
emoji <- load_image("../../staticimages/posts/conteudo/captcha-conv/emoji3.png")[,,1] 
