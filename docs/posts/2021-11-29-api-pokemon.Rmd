...
image: "images/posts/banner/API-drake.webp"
...
knitr::include_graphics("https://media.giphy.com/media/giEBaPNKEtjZtK43oX/giphy.gif")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/pbGSpeX860JxK/giphy.gif")
```
