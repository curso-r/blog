...
image: "images/posts/banner/scraper-cetesb.jpg"
author: ["William"]
...
knitr::include_graphics("/images/posts/conteudo/scraper-cetesb/qualar_login.png")
```
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("/images/posts/conteudo/scraper-cetesb/qualar_form.png")
```
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("/images/posts/conteudo/scraper-cetesb/qualar_dados.png")
```
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("/images/posts/conteudo/scraper-cetesb/inspect-form-login.png")
```
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("/images/posts/conteudo/scraper-cetesb/inspect_login.png")
```
