...
image: "images/posts/banner/dog-pc.webp"
author: ["Beatriz Milz", "Fernando"]
...
Se você quiser aprender um pouco mais sobre R em geral, dê uma olhada nos [Cursos da Curso-R](https://curso-r.com/#portfolio) e aproveite! O próximo curso a iniciar é o [R para Ciência de Dados II](https://curso-r.com/cursos/r4ds-2/), e a primeira parte do curso é sobre organização de projetos, um tema muito presente neste post. 🎉
