...
knitr::include_graphics("/images/posts/conteudo/r-telegram-bitcoin/r_telegram.gif")
```
...
```{r, fig.align='center', echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/r-telegram-bitcoin/serie_bitcoin.png")
```
...
```{r, fig.align='center', echo=FALSE}
knitr::include_graphics("/images/posts/conteudo/r-telegram-bitcoin/Renvirom_1.png")
```
