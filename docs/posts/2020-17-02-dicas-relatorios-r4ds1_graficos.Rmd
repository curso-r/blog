...
image: "images/posts/banner/ggplot2_blank.webp"
...
Porém não podemos apresentar todas as `r nrow(imdb_lucro_diretores)` pessoas diretoras no mesmo gráfico, pois não seria legível! Precisamos definir alguns critérios para selecionar as pessoas diretoras que aparecerão no gráfico. 
